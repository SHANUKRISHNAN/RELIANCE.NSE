...
if page == "🏠  Dashboard":
    ...
    # ── Full price history ────────────────────────────────────────────────
    st.plotly_chart(chart_price_history(df), use_container_width=True, key="pc_1")
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    st.plotly_chart(
        ...
        use_container_width=True, key="pc_5"
    )
    ...
    with col1:
        ...
        st.plotly_chart(
            ...
            use_container_width=True, key="pc_6"
        )
    with col2:
        # Scatter
        st.plotly_chart(
            ...
            use_container_width=True, key="pc_7"
        )

    # ── Fold metrics comparison ───────────────────────────────────────────
    st.markdown("<div class='section-header'>Walk-Forward Fold Metrics</div>",
                unsafe_allow_html=True)
    st.plotly_chart(chart_fold_metrics(metrics_df), use_container_width=True, key="pc_3")
    ...
    with st.expander("📋 View raw forecast data"):
        st.dataframe(
            ...
            use_container_width=True, key="pc_5", hide_index=True
        )
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    with tab2:
        ...
        st.plotly_chart(
            ...
            use_container_width=True, key="pc_9"
        )
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    st.plotly_chart(
        ...
        use_container_width=True, key="pc_10"
    )
    ...
    with st.expander("📋 View forecast table"):
        ...
        st.dataframe(tbl, use_container_width=True, key="pc_6", hide_index=True)
